...
(defconst catppuccin-themes-faces
  '(
    ...
    `(hi-aquamarine ((,c :background ,base :foreground ,sapphire :inverse-video t)))
    `(hi-black-b ((,c :inverse-video t)))
    `(hi-black-hb ((,c :background ,base :foreground ,subtext0 :inverse-video t)))
    `(hi-blue ((,c :background ,base :foreground ,blue :inverse-video t)))
    `(hi-blue-b ((,c :inherit (bold hi-blue))))
    `(hi-green ((,c :background ,base :foreground ,green :inverse-video t)))
    `(hi-green-b ((,c :inherit (bold hi-green))))
    `(hi-pink ((,c :background ,base :foreground ,pink :inverse-video t)))
    `(hi-red-b ((,c :background ,base :foreground ,red :inverse-video t)))
    `(hi-salmon ((,c :background ,base :foreground ,peach :inverse-video t)))
    ...
    `(markdown-header-face-1 ((,c :foreground ,red :weight bold)))
    `(markdown-header-face-2 ((,c :foreground ,peach :weight bold)))
    `(markdown-header-face-3 ((,c :foreground ,yellow :weight bold)))
    `(markdown-header-face-4 ((,c :foreground ,green :weight bold)))
    `(markdown-header-face-5 ((,c :foreground ,sapphire :weight bold)))
    `(markdown-header-face-6 ((,c :foreground ,lavender :weight bold)))
    ...
    `(org-agenda-date ((,c :foreground ,sapphire :weight normal)))
    `(org-agenda-date-today ((,c :inherit org-agenda-date :underline t)))
    `(org-agenda-date-weekend ((,c :inherit org-agenda-date :foreground ,flamingo)))
    `(org-agenda-date-weekend-today ((,c :inherit org-agenda-date-today :foreground ,flamingo)))
    ...
    `(org-level-1 ((,c :foreground ,red :weight bold)))
    `(org-level-2 ((,c :foreground ,peach :weight bold)))
    `(org-level-3 ((,c :foreground ,yellow :weight bold)))
    `(org-level-4 ((,c :foreground ,green :weight bold)))
    `(org-level-5 ((,c :foreground ,sapphire :weight bold)))
    `(org-level-6 ((,c :foreground ,lavender :weight bold)))
    `(org-level-7 ((,c :foreground ,mauve :weight bold)))
    `(org-level-8 ((,c :foreground ,maroon :weight bold)))
