...
(defconst catppuccin-themes-faces
  '(
    ...
    `(markdown-header-face ((,c :weight normal)))
    `(markdown-header-face-1 ((,c :foreground ,red)))
    `(markdown-header-face-2 ((,c :foreground ,peach)))
    `(markdown-header-face-3 ((,c :foreground ,yellow)))
    `(markdown-header-face-4 ((,c :foreground ,green)))
    `(markdown-header-face-5 ((,c :foreground ,sapphire)))
    `(markdown-header-face-6 ((,c :foreground ,lavender)))
