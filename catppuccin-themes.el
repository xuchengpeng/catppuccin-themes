...
(defconst catppuccin-themes-faces
  '(
    ...
    `(org-dispatcher-highlight ((,c :background ,mantle :foreground ,blue :weight bold)))
    ...
    `(org-list-dt ((,c :inherit bold :foreground ,subtext1)))
    ...
    `(org-scheduled ((,c :foreground ,yellow)))
